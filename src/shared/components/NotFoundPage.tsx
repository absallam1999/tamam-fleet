...
const t = {
  ...
  requests: { ar: "طلبات الانضمام", en: "Requests" },
...
const quickLinks = [
  ...
  },
  {
    ...
    labelAr: t.drivers.ar,
    labelEn: t.drivers.en,
    icon: (
      <svg
        className="w-4 h-4"
        fill="none"
  ...
  },
  {
    ...
    labelAr: t.requests.ar,
    labelEn: t.requests.en,
    icon: (
      <svg
        className="w-4 h-4"
        fill="none"
  ...
  },
  {
    ...
    labelAr: t.notifications.ar,
    labelEn: t.notifications.en,
    icon: (
      <svg
        className="w-4 h-4"
        fill="none"
      ...
      <div className="w-full max-w-2xl">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 sm:gap-4 relative">
            {/* Number 4 */}
            <span className="text-[100px] sm:text-[140px] md:text-[160px] font-black leading-none tracking-tighter bg-gradient-to-br from-primary-400 via-primary-500 to-primary-600 bg-clip-text text-transparent dark:from-primary-300 dark:via-primary-400 dark:to-primary-500 drop-shadow-sm">
              4
            </span>
            ...
            {/* Number 4 */}
            <span className="text-[100px] sm:text-[140px] md:text-[160px] font-black leading-none tracking-tighter bg-gradient-to-br from-sky-500 via-primary-500 to-primary-400 bg-clip-text text-transparent dark:from-sky-400 dark:via-primary-400 dark:to-primary-300 drop-shadow-sm">
              4
            </span>
          </div>
        </div>
